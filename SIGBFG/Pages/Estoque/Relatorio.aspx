    ...
    <div style="margin-top: 20px;">
            <form id="form1" runat="server" aria-atomic="False">
                ...
                <center><h1>Relatório de Produtos em Estoque</h1></center>
                   ...
                   <center><asp:Label ID="txtPorcentagem" runat="server"></asp:Label></center> 
                    <br />
                    <br />
                <br />

                <center><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="100px" Width="60%" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
                ...
                <br />
                <center><label>Total de Produtos</label></center>
                    <br />
                <br />
                <center><asp:Label ID="txtTotal" runat="server"></asp:Label></center>
                <br />
            </form>
        <br />
        <center></center><h3>Gráfico de Produtos em Estoque</h3>
