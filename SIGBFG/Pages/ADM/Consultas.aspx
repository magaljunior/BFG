<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consultas.aspx.cs" Inherits="Pages_ADM_Consultas" %>
						...
						<div class="menu-list">
							...
							<ul id="menu-content" class="menu-content collapse out">
								...
								<li data-toggle="collapse" data-target="#products" class="collapsed active">
									<a href="#"><i class="fa fa-gift fa-lg"></i>Menu - BFG<span class="arrow"></span></a>
								</li>
								...
								<li data-toggle="collapse" data-target="#service" class="collapsed">
									...
									<li><a href="../CadCliente/ListarCL.aspx">Cliente</a></li>
									<li><a href="../Despesa/ListarDespesa.aspx">Despesa</a></li>
									<li><a href="../Metas/Listar.aspx">Metas</a></li>
									<li><a href="../Motivos/Listar_Motivo.aspx">Motivos</a></li>
									<li><a href="../OS/Listar.aspx">Ordem de Serviço</a></li>
									<li><a href="../Perda/Listar.aspx">Perda</a></li>
									<li><a href="../Produtos/ListarPD.aspx">Produtos</a></li>
									<li><a href="../Usuario/Listar_usuario.aspx">Usuario</a></li>
									<li><a href="../Vendas/Listar.aspx">Vendas</a></li>
								</li>
